...
[start=2]
. Once the session is established, open your Remote Desktop application and enter localhost:56788. (Or any port number not currently in use.)
. Select *Connect*.
...
[start=4]
. Once you are done you can end your Remote Desktop session and disconnect.
